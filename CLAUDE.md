...
- **Evidence photos stay static (Andrew, 2026-07-11):** before/after result composites never get zoom, drift, or parallax motion. Their frames match the photo ratio exactly, so any scale or translate crops the faces — the proof must be fully readable. Motion treatments belong on mood/editorial imagery only.
